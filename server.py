...
app = FastAPI(title="ComfyUI SDXL Upscaler Endpoint")
comfy_process = None
...
def ensure_comfyui_running():
    try:
        ...
        proc = subprocess.Popen(
            [python_bin, main_py, "--listen", "127.0.0.1", "--port", "8188", "--disable-auto-launch"],
            stdout=log_handle,
...
async def upscale(file: UploadFile = File(...)):
    ...
    # Save uploaded bytes to local input path
    ...
    try:
        ...
        # Update filename in LoadImage node
